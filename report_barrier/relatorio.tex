...
Nas figuras que irão ser expostas tem-se a verde os resultados do \textit{Barrier Method} e a vermelho do \textit{CVX}.  Os retornos e os riscos dos \textit{assets} são iguais para ambos os programas.
...
\captionsetup{font=scriptsize}  
  \centering
  \includegraphics[width=0.9\columnwidth]{./tempo_metodos}
...
A partir da utilização do \textit{Barrier Method} foi possível aproximar os resultados aos obtidos pelo \textit{CVX} só que com um tempo bastante inferior.
